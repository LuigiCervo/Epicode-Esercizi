...
*/ 
 for(let i = 0; i < starWarsCharacters.length; i++ ){ //graffe per gli algoritmi (stringhe di codice), quadre per gli array , tonde per if else for else if ecc...
 characters.push(starWarsCharacters[i].name); 
}
console.log(characters);

// Se voglio richiamare una proprietà (componente di un oggetto) precisa di un oggetto , la richiamo con nomedelloggetto.nomedellaproprietà in questo caso dovevami richiamare anche i(indice di inizio) dato che nel ciclo for 0 è l'indice di partenza e dovevamo la proprietà i ha come valore l'indice di partenza 0 ergo il primo elemento di proprietà name dell'oggetto StarWarsCharacters 
...
*/
var fermaleCharacters = [{
  name: 'Leia Organa',
  hair_color: 'brown',
  eye_color: 'brown'
}
];
console.log(fermaleCharacters);
...
switch(starWarsCharacters[i].eye_color){
  ...
  break;
    ...
    break
    case 'blue__gray' : 
    eyeColor.blue__gray.push(starWarsCharacters[i].name);
    break
