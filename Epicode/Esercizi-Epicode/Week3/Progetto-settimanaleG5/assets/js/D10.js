...
function onlyLetters(stringa) {
  if (stringa.match(/[0-9]/g)) {
    return stringa.replace(/[0-9]/g, "");
  } else return stringa;
}

console.log(onlyLetters("I have 3 dogs"));
...
console.log(isThisAnEmail("fake.email@gmail.com"));
...
function howManyDays(date){
  let today= new Date();
  let dayPassed= Date.parse(today) - Date.parse(date);
  dayPassed=Math.floor(dayPassed/1000/60/60/24);
  return dayPassed
  }
  console.log(howManyDays('March 25, 2022'));
...
console.log(deleteProp(ogg,'property'))
